...
if (bridgeCta)
  bridgeCta.addEventListener("click", () => {
    document.querySelector("#top").scrollIntoView({ behavior: "smooth" });
...
const QUIZ = [
  ...
  },
  {
    ...
    sub: "Be honest, this helps us determine whether Revive Veneers are right for you.",
    opts: [
...
const RESULTS = {
  ...
  good: {
    ...
    tagLabel: "Good candidate Â· extended timeline",
    ...
    primary: { label: "Add to Cart", action: "buy" },
    secondary: { label: "Send us photos for a fit check", action: "photos" },
  },
  consult: {
    ...
    primary: { label: "Send us photos for a fit check", action: "photos" },
...
function handleAction(a) {
  ...
  if (a === "buy") {
    ...
    window.location.href =
      "mailto:hello@reviveteeth.com?subject=Fit%20check%20for%20Revive%20Veneers&body=Hi%20Revive%20Team%2C%0A%0AI%27d%20like%20a%20fit%20check%20on%20my%20photos%20before%20I%20order.%20Please%20find%20attached%3A%0A%0A1.%20A%20front-facing%20smile%20photo%0A2.%20A%20close-up%20of%20my%20teeth%20%28lips%20pulled%20back%29%0A3.%20A%20side%20profile%20of%20my%20smile%0A%0AMy%20specific%20concerns%3A%20%5Bplease%20describe%5D%0A%0AThank%20you.";
  }
}
